...
const file_api_v1_api_proto_rawDesc = "" +
	...
	"\x10GetCurrentConfig\x12\x1f.api.v1.GetCurrentConfigRequest\x1a .api.v1.GetCurrentConfigResponseB\x86\x01\n" +
	"\n" +
	"com.api.v1B\bApiProtoP\x01Z5gofronet-foundation/gofro-control/gen/go/api/v1;apiv1\xa2\x02\x03AXX\xaa\x02\x06Api.V1\xca\x02\x06Api\\V1\xe2\x02\x12Api\\V1\\GPBMetadata\xea\x02\aApi::V1b\x06proto3"
