...
const (
	SecurityService_Renew_FullMethodName = "/api.security.v1.SecurityService/Renew"
)
...
func (c *securityServiceClient) Renew(ctx context.Context, in *RenewRequest, opts ...grpc.CallOption) (*RenewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RenewResponse)
	err := c.cc.Invoke(ctx, SecurityService_Renew_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSecurityServiceServer) Renew(context.Context, *RenewRequest) (*RenewResponse, error) {
...
func _SecurityService_Renew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecurityServiceServer).Renew(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecurityService_Renew_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecurityServiceServer).Renew(ctx, req.(*RenewRequest))
	}
...
var SecurityService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.security.v1.SecurityService",
	HandlerType: (*SecurityServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Renew",
			Handler:    _SecurityService_Renew_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/security/v1/security.proto",
}
